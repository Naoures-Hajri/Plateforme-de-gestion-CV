...
@Component({
  selector: 'app-step-cre-cv',
  templateUrl: './step-cre-cv.component.html',
  styleUrls: ['./step-cre-cv.component.scss']
})
export class StepCreCVComponent {
  cvForm!: FormGroup;
  ...
  constructor(private cvService: CvService, private fb: FormBuilder, private router: Router) {}
  ngOnInit(): void {
